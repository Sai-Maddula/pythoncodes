...
"""
all the values after equalling will be equal to N itself the number of operartions can be mathematically derived as
N-(2i+1)+N-(2i+1)..... and can be caculated by above formula
"""
